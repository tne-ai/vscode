...
// Web environment or unknown
	...
	if (Object.keys(product).length === 0) {
		Object.assign(product, {
			version: '1.102.0-dev',
			nameShort: 'Compass - OSS Dev',
			nameLong: 'Compass - OSS Dev',
			applicationName: 'compass-oss',
			dataFolderName: '.compass-oss',
			urlProtocol: 'compass-oss',
			reportIssueUrl: 'https://github.com/tne-ai/vscode/issues/new',
			licenseName: 'MIT',
			licenseUrl: 'https://github.com/tne-ai/vscode/blob/main/LICENSE.txt',
			serverLicenseUrl: 'https://github.com/tne-ai/vscode/blob/main/LICENSE.txt',
